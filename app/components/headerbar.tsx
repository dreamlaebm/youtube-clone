                ...
                <div className="flex justify-between md:gap-40 xl:gap-52 p-4 my-4 items-center h-full w-full">
                    ...
                    <div className="grow-[2] max-w-[670px]">
                        <div className="h-full w-full flex gap-0">
                            <input placeholder="Search" className="rounded-l-full bg-stone-900 center p-2 pl-4 basis-5/6 text-white outline-none max-w-[650px]">
                            </input>
                    ...
                    <div className="grow-1">
                        <img src="https://www.infoescola.com/wp-content/uploads/2012/11/tio-sam.jpg" className="w-8 h-8 rounded-full" />
